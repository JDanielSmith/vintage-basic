	...
	public class TokenizerTests
	{
		...
		public void LetStatementTokenizeTest()
		{
			...
			Assert.Collection(tokens,
				...
				t => { Assert.IsType<VarNameToken>(t.Value); Assert.Equal("a", ((VarNameToken)t.Value).Name); Assert.Equal(0.0f, ((VarNameToken)t.Value).Val); Assert.Equal(new SourcePosition(20, 5), t.Position); },
