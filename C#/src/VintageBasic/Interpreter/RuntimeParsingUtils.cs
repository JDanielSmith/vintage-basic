// src/VintageBasic/Interpreter/RuntimeParsingUtils.cs
using System;
...
static class RuntimeParsingUtils
{
    ...
    {
        if (TryParseFloat(s, out float val)) return val;
        return 0.0f; // BASIC often treats unparseable numeric input as 0.
    }
